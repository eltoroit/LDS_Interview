...
**EL TORO:**	Actually, yes… and it’s pretty simple. Take a look at this code.
...
[ELTORO]:	Actually, not… you would need to use some components, rather than events, but it’s quite simple. Let’s take a look at some examples…
Component: <force:recordView />
**EL TORO:**	<force:recordView /> is possible the easiest way to display a record. This component displays the record using it’s page layout on the screen.
...
**READER:**	I have used <apex:detail /> is many of the pages I built with 

Component: <force:recordEdit />
[ELTORO]:	One more thing, with Visualforce you were able to use <apex:detail /> to view a record but not to edit the records. If you wanted that, you had to write a lot of code. But Salesforce now gives us <force:recordEdit /> which allows the user to edit the records without

**EL TORO:**	On the other hand, if you want that page layout to be in edit mode, you can use the <force:recordEdit /> component.  This is how the markup for that looks:
...
**EL TORO:**	As you may know LDS keeps rec …
**READER:**	Sorry to interrupt, what is LDS?
**EL TORO:**	LDS is just Lightning Data Service, and we’ll talk in detail about that in just a bit…
**READER:**	Ok, thanks… you were saying?
**EL TORO:**	Oh yes, as you know LDS uses a mechanism to keep the records synchronized among the different components that use that record…
...
[ELTORO]:	And remember no, A, and we have not need to write a single line of Apex!
**EL TORO:**	We have written a bit of markup and JavaScript!
...
**EL TORO:**	Not quite, let me show you few more options.
...
Components: <lightning:recordViewForm /> and <lightning:outputField />
